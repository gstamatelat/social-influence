...
public enum GraphOptions {
     ...
     * {@link Graph#getVertices()}. {@code HashSet} elements don't have any particular order while {@code LinkedHashSet}
     ...
     * {@code LinkedHashSet} has slightly slower add() but faster next(). This setting has an effect on the iterator of
     * {@link Graph#getEdges()}. {@code HashSet} elements don't have any particular order while {@code LinkedHashSet}
