...
public class SimpleMatchingSimilarity<V> implements VertexSimilarity<V, Double> {
    ...
    /**
     * Construct a {@code SimpleMatchingSimilarity} instance from a {@link Graph}. The constructor doesn't perform any
     * calculations.
     *
     * @param g the {@link Graph} to construct this instance from
     * @throws NullPointerException if {@code g} is {@code null}
     */
    public SimpleMatchingSimilarity(Graph<V, ?> g) {
        this.g = Conditions.requireNonNull(g);
    }

    /**
     * Calculates the SMC between two vertices. This method runs in time proportional to the out degrees of the input
     * vertices and uses constant extra space. This method runs slightly faster when {@code v2} has more outgoing edges
     * than {@code v1}.
     *
     * @param v1 one vertex
