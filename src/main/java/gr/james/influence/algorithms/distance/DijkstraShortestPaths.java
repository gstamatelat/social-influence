...
public class DijkstraShortestPaths<V> implements SingleSourceShortestPaths<V> {
    ...
    /**
     * Construct an instance of {@link DijkstraShortestPaths} with a given {@link DirectedGraph} and a {@code source}. The
     ...
     */
    public DijkstraShortestPaths(@UnmodifiableGraph DirectedGraph<V, ?> g, V source) {
