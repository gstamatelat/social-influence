...
public interface Graph<V, E> extends Iterable<V>, Metadata {
    ...
    default Iterable<GraphEdge<V, E>> edges() {
        return () -> new BufferedIterator<GraphEdge<V, E>>() {
            ...
            private Iterator<GraphEdge<V, E>> edgeIterator;
            ...
            protected Iterator<GraphEdge<V, E>> proceed() {
                while (vertexIterator.hasNext() && !edgeIterator.hasNext()) {
                    edgeIterator = Graph.this.getOutEdges(vertexIterator.next()).values().iterator();
                }
                if (edgeIterator.hasNext()) {
                    return Iterators.singletonIterator(edgeIterator.next());
                } else {
