...
/**
 * Represents a weighted and directed {@link Graph} which can contain self loops but not parallel edges.
 *
...
public interface DirectedGraph<V, E> extends Graph<V, E> {
    ...
    /**
     * Returns an edge reversed view of this graph.
     * <p>
     * An edge reversed graph contains all the vertices of the original graph but with reversed edge directions. The
     * graph generated by this method is a view of this graph, which means that changes to this graph will reflect to
     * the edge reversed graph and vice versa.
     *
     * @return an edge reversed view of this graph
     */
