...
public class ConnectedComponentsTests {
    ...
    public void isolated() {
        ...
        final DirectedGraph<Integer, Object> g = new DirectedPathGenerator<Integer, Object>(n).generate(VertexProvider.INTEGER_PROVIDER);
    ...
    public void complete() {
        final int n = 25;
        final DirectedGraph<Integer, Object> g = new CompleteGenerator<Integer, Object>(n).generate(VertexProvider.INTEGER_PROVIDER);
        final ConnectedComponents<Integer> cc = factory.apply(g);
    ...
    public void clusters() {
        final DirectedGraph<Integer, Object> g1 = new CompleteGenerator<Integer, Object>(10).generate(VertexProvider.INTEGER_PROVIDER);
        final DirectedGraph<Integer, Object> g2 = new CompleteGenerator<Integer, Object>(15).generate(VertexProvider.INTEGER_PROVIDER);
        final DirectedGraph<Integer, Object> g3 = new CompleteGenerator<Integer, Object>(20).generate(VertexProvider.INTEGER_PROVIDER);
    ...
    public void random() {
        final int n = 100;
        final DirectedGraph<Integer, Object> g = new RandomGenerator<Integer, Object>(n, 0.1, true).generate(VertexProvider.INTEGER_PROVIDER);
        final ConnectedComponents<Integer> cc = factory.apply(g);
